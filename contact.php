...
<section class="mx-auto max-w-5xl px-4 py-20 sm:px-6 lg:px-8">
    ...
    <div class="grid gap-4 sm:grid-cols-2">
        ...
        <!-- WhatsApp -->
        <a href="https://wa.me/233249898478" target="_blank" rel="noopener"
           class="contact-card group fade-in">
            <div class="social-icon flex-shrink-0" style="background:#25D366; color:white;">
            ...
            <div class="min-w-0">
                ...
                <p class="text-slate-500 text-xs mt-0.5">Chat with the SCOTSA team</p>
                <p class="text-xs font-semibold mt-1" style="color:#25D366;">0249 898 478</p>
            </div>
        ...
        <!-- Email -->
        <a href="mailto:info@scotsa.edu.gh"
           class="contact-card group fade-in fade-in-delay-1">
            <div class="social-icon flex-shrink-0" style="background:#0A1F44; color:white;">
            ...
            <div class="min-w-0">
                ...
                <p class="text-xs font-semibold mt-1 text-scotsaBlue">info@scotsa.edu.gh</p>
            </div>
            <svg class="h-4 w-4 text-slate-300 flex-shrink-0 ml-auto transition group-hover:text-slate-500 group-hover:translate-x-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/>
            </svg>
        ...
        <!-- Facebook -->
        <a href="https://www.facebook.com/share/1EWphDFXPQ/?mibextid=wwXIfr" target="_blank" rel="noopener"
           class="contact-card group fade-in fade-in-delay-1">
            <div class="social-icon flex-shrink-0" style="background:#1877F2; color:white;">
                <svg class="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div class="min-w-0">
                ...
                <p class="text-xs font-semibold mt-1" style="color:#1877F2;">SCOTSA, WIUC</p>
            </div>
            <svg class="h-4 w-4 text-slate-300 flex-shrink-0 ml-auto transition group-hover:text-slate-500 group-hover:translate-x-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/>
            </svg>
        ...
        <!-- Instagram -->
        <a href="https://www.instagram.com/scotsa_wiuc?igsh=MWxqZ2RtdXQwaGt1Yw==" target="_blank" rel="noopener"
           class="contact-card group fade-in fade-in-delay-2">
            <div class="social-icon flex-shrink-0" style="background:linear-gradient(135deg, #f09433 0%,#e6683c 25%,#dc2743 50%,#cc2366 75%,#bc1888 100%); color:white;">
                <svg class="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
        ...
        <!-- TikTok -->
        <a href="https://www.tiktok.com/@scotsa_wiuc?_r=1&_t=ZS-96Rp4CPj93E" target="_blank" rel="noopener"
           class="contact-card group fade-in fade-in-delay-2">
            <div class="social-icon flex-shrink-0" style="background:#010101; color:white;">
                <svg class="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div class="min-w-0">
                ...
                <p class="text-xs font-semibold mt-1" style="color:#ff0050;">@scotsa_wiuc</p>
            </div>
            <svg class="h-4 w-4 text-slate-300 flex-shrink-0 ml-auto transition group-hover:text-slate-500 group-hover:translate-x-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/>
            </svg>
        ...
        <a href="https://x.com/scotsawiuc?s=21" target="_blank" rel="noopener"
           class="contact-card group fade-in fade-in-delay-3">
            <div class="social-icon flex-shrink-0" style="background:#000000; color:white;">
                <svg class="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div class="min-w-0">
                ...
                <p class="text-xs font-semibold mt-1" style="color:#000000;">@scotsawiuc</p>
            </div>
            <svg class="h-4 w-4 text-slate-300 flex-shrink-0 ml-auto transition group-hover:text-slate-500 group-hover:translate-x-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/>
            </svg>
...
<section class="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
    <div class="grid gap-6 md:grid-cols-2">
        ...
        <div class="rounded-2xl p-8 text-white fade-in" style="background:linear-gradient(135deg, #0A1F44 0%, #0d2a5c 100%);">
            ...
            <div class="grid gap-4 text-sm text-blue-100/80">
                <div>
                    <p class="text-xs font-bold uppercase tracking-wider mb-1" style="color:#D4AF37;">Institution</p>
                    <p class="leading-6">Wisconsin International University College<br>
                    <span style="color:rgba(191,219,254,.55);">Ghana</span></p>
                </div>
                <div>
                    <p class="text-xs font-bold uppercase tracking-wider mb-1" style="color:#D4AF37;">Office</p>
                    <p class="leading-6">School of Computing and Technology<br>Departmental Student Office</p>
                </div>
                <div>
                    <p class="text-xs font-bold uppercase tracking-wider mb-1" style="color:#D4AF37;">WhatsApp</p>
                    <a href="https://wa.me/233249898478" class="hover:text-white transition">0249 898 478</a>
                </div>
                <div>
                    <p class="text-xs font-bold uppercase tracking-wider mb-1" style="color:#D4AF37;">Email</p>
                    <a href="mailto:info@scotsa.edu.gh" class="hover:text-white transition">info@scotsa.edu.gh</a>
                </div>
                <div>
                    <p class="text-xs font-bold uppercase tracking-wider mb-1" style="color:#D4AF37;">Office Hours</p>
        ...
        <a href="https://maps.app.goo.gl/xYnrCU3t9MBHGarq9" target="_blank" rel="noopener"
           class="group rounded-2xl border border-slate-200 overflow-hidden flex flex-col fade-in fade-in-delay-1 hover:border-scotsaGold transition-colors duration-200"
           style="min-height:280px;">
            ...
            <div class="flex-1 flex flex-col items-center justify-center p-8 text-center relative"
                ...
                <div class="relative mb-4">
                    <div class="grid h-16 w-16 place-items-center rounded-2xl shadow-lg transition-transform duration-300 group-hover:-translate-y-1"
                         style="background:#0A1F44;">
                        <svg class="h-8 w-8" style="color:#D4AF37;" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.75">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/>
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
                        </svg>
                    </div>
                    <!-- Pin shadow -->
                    <div class="mx-auto mt-1 h-1.5 w-8 rounded-full opacity-20" style="background:#0A1F44;"></div>
                </div>
                <h3 class="font-heading font-bold text-ink text-base mb-1">Live Location</h3>
                <p class="text-xs text-slate-500 leading-5 max-w-xs">
                    Wisconsin International University College, Ghana<br>
                    <span class="text-slate-400">School of Computing &amp; Technology</span>
                </p>
            </div>
            <!-- CTA bar -->
            <div class="flex items-center justify-between px-5 py-3.5 border-t border-slate-200 bg-white group-hover:bg-scotsaBlue transition-colors duration-200">
