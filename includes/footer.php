        ...
        <div class="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="lg:col-span-2">
                ...
                <a href="<?= BASE_URL ?>/index.php"
                   ...
                   aria-label="SCOTSA Home">
                    ...
                    <img src="<?= $footerLogoSrc ?>"
                         ...
                         style="filter:drop-shadow(0 2px 8px rgba(212,175,55,.18));"
                ...
                <div class="mt-6 flex gap-2.5">
                    <?php
                    $socials = [
                        ['Facebook',  'https://www.facebook.com/share/1EWphDFXPQ/?mibextid=wwXIfr',              'M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z'],
                        ['Instagram', 'https://www.instagram.com/scotsa_wiuc?igsh=MWxqZ2RtdXQwaGt1Yw==',         'M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zM17.5 6.5h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z'],
                        ['X',         'https://x.com/scotsawiuc?s=21',                                           'M4 4l16 16M20 4L4 20'],
                        ['TikTok',    'https://www.tiktok.com/@scotsa_wiuc?_r=1&_t=ZS-96Rp4CPj93E',              'M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.69a8.18 8.18 0 004.78 1.52V6.75a4.85 4.85 0 01-1.01-.06z'],
                    ];
            ...
            <div>
                ...
                <div class="grid gap-3 text-sm" style="color:rgba(191,219,254,.65);">
                    ...
                    <p>
                        <a href="mailto:info@scotsa.edu.gh" class="hover:text-white transition-colors duration-150 underline underline-offset-2 decoration-transparent hover:decoration-current">
                            info@scotsa.edu.gh
                        </a>
                    </p>
