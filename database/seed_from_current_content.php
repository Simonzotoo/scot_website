...
try {
    ...
    $heads = [
        ...
        [
            ...
            'publications' => [
                'Amankwah, R., Chen, J., Kudjo, P. K., & Towey, D. (2020). An empirical comparison of commercial and open-source web vulnerability scanners.',
                'Amankwah, R., Chen, J., Kudjo, P. K., Agyemang, B. K., & Amponsah, A. A. (2020). An automated framework for evaluating open-source web scanner vulnerability severity.',
                'Amankwah, R., Chen, J., Mensah, S., & Kudjo, P. K. (2020). The effect of Bellwether analysis on software vulnerability severity prediction models.',
                'Amankwah, R., Chen, J., Amponsah, A. A., Ocran, V., & Anang, C. O. (2020). Fast bug detection algorithm for identifying potential vulnerabilities in Juliet test cases.',
                'Amankwah, R., Agyeman, B. K., Mensah, K., Brew, B., & Antwi, S. Y. (2018). An integrated approach for detecting security vulnerabilities in web applications: a theoretical perspective.',
                'Amankwah, R., Chen, J., & Mensah, S. (2018). Predicting vulnerable software components via Bellwethers.',
                'Amankwah, R., & Antwi, S. Y. (2017). Evaluation of software vulnerability detection methods and tools: a review.',
                'Ben-Bright, B., Zhan, Y., Ghansah, B., Amankwah, R., et al. (2017). Taxonomy and a theoretical model for feedforward neural networks.',
                'Adjardjah, W., Amankwah, R., Okine, A. A., et al. (2017). A fuzzy logic QoE enhancement VHO scheme for VLC-RF HetNet in an indoor environment.',
            ],
            'education' => [
                'PhD Computer Application Technology, Jiangsu University, China',
                'MSc Information Technology, Sikkim Manipal University, India',
                'BEd Information Technology, University of Education, Winneba',
            ],
        ],
        [
